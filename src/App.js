...
function App() {
    ...
    if ("serviceWorker" in navigator) {
      ...
      let push = await sw.pushManager.subscribe({
        ...
        applicationServerKey:
          "BEF3iDEv-jEKmt9837kUHg5NSQeyI_nwgx9aUPVyvlWCEuCIU1DrAh58NKqo-LhOgqvyCnAbTOgvhW05j8frPFc",
      });
  ...
  const updateUserEndPoint = async (pushData) => {
    ...
    if (updateUser.data.err) {
      ...
      toast.success(
        "Profile successfully updated! We will notify you everyday once your Login and Post Reward are ready"
      );
      ...
      >
        <Routes>
          ...
          <Route
            exact
            path="/p/:slug"
            element={<SalesProgram setShowTab={setShowTab} />}
          />
