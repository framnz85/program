...
import { AiOutlineFile, AiFillFile, AiOutlineFileAdd, AiFillFileAdd, AiOutlineUser } from "react-icons/ai";
        ...
        <div style={tabStyle.containier}>
            {isMobile && token && (
                <div style={tabStyle.bottomNav}>
                    ...
                    <div style={tabStyle.bnTab} onClick={() => navigateTab('/myprograms')}>
                        <div>
            ...
            <Modal title="Notification Request" open={notifyRequest} onOk={handleOk} onCancel={handleCancel} okText="Send Me">
                <br />
                <p>To maximize your profitability, we require you to allow us to send you notification when your Login Reward and Post Reward are ready for the day.</p>
                <br />
            </Modal>
        </div>
    );
