...
const MainFooter = ({setTabMenu = () => "", noRedirect = false}) => {
    ...
    const checkPostToday = async() => {
        ...
        if (result.data.err) {
            ...
            if (!result.data.postToday && !sessionStorage.getItem("postPrompt") && stopPostReward !== dateToday) {
                setIsModalOpen(true);
                setRewardType(3);
            } else {
                setIsModalOpen(false);
            ...
            <Modal title="" open={isModalOpen} onCancel={handleCancel} footer={null} >
                {rewardType === 1 && <>
                    <div align="center" style={{paddingTop: 20}}>
                        <h5>Thank you for logging in back!!!</h5> Receive your today's Login Reward by pressing the button below.<br />
                        <img src={process.env.REACT_APP_CLAVMALL_IMG + "/funnel_images/loginreward.jpg"} alt="Login Reward" width="80%" />
                        <Button
                            type="primary"
                            style={{
                ...
                {rewardType === 2 && <>
                    <div align="center" style={{paddingTop: 20}}>
                        <img
                            src={
                                rewardAmount === 2 ? process.env.REACT_APP_CLAVMALL_IMG + "/funnel_images/congrats2.gif"
                                    : process.env.REACT_APP_CLAVMALL_IMG + "/funnel_images/congrats1.gif"
                            }
                            alt="Login Reward Received" width="80%"
                        />
                        <Button
                            type="primary"
                            style={{
                ...
                {rewardType === 3 && <>
                    <div align="center" style={{paddingTop: 20}}>
                        <h5>Earn your Post Reward now!!!</h5> <h6>Follow the instructions shown in the video.</h6><br />
                        <iframe
